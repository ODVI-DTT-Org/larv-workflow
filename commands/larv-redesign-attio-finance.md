...
- Use `attio-finance-html-effectiveness-design/` as the required design source.
...
- Redesign the whole frontend shell and user-facing screens into the Attio Finance CRM language: gold/blue tokens, dense CRM tables, restrained app shell, command/search surfaces, metric strips, filters, drawers/modals, state badges, and high-fidelity empty/loading/error states.
...
- `docs/larv/redesigns/<timestamp>-attio-finance/design-source.md`
- `docs/larv/redesigns/<timestamp>-attio-finance/screen-inventory.md`
- `docs/larv/redesigns/<timestamp>-attio-finance/implementation-report.md`
- `docs/larv/redesigns/<timestamp>-attio-finance/visual-parity.md`
